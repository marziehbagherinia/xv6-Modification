...
void            set_bjf_params_proc(int, int, int, int);
void            set_bjf_params_system(int, int, int);
...
int             argstr(int, char**);
int             argstruct(int n, struct condvar *ip);
int             fetchint(uint, int*);
int             fetchstr(uint, char**);
int             fetchstruct(uint addr, struct condvar *ip);
void            syscall(void);
